...
import { AlignLeft, HistoryIcon, LayoutGrid } from 'lucide-react';
  ...
  return (
    ...
    >
        ...
        <div className='mt-10 flex justify-between'>
            <div>
                <span className='font-medium  inline-flex justify-center items-center text-gray-500'><HistoryIcon/> &nbsp; Recent Workspaces</span>
            </div>
